...
export default function MobileNav({ isOpen }: MobileNavProps) {
  return (
    <div
      className={`${
        isOpen ? "block" : "hidden"
      } transition-all duration-150 ease-in-out absolute bg-white top-full right-3 w-[calc(100vw_-_24px)] max-w-[250px] rounded-[15px] overflow-hidden z-10 lg:hidden`}
      style={{
        boxShadow:
