    ...
    <div className="w-full  bg-gray-200 ">
      ...
      >
        ...
        <section className="absolute top-0 left-0 w-full z-10 flex justify-center md:relative md:shrink-0 md:h-[420px] md:w-[345px] xlg:h-[500px] xlg:w-[450px] overflow-hidden">
          <Image
            src={heroImage}
            className="w-full sm:min-h-full sm:w-[80%] md:absolute md:top-0 md:left-0 md:w-full md:h-auto"
        ...
        <section className="hidden absolute left-[30%] bottom-0 w-full md:block">
          <p className="text-[100px] leading-[100px] text-gray-100 uppercase lg:text-[150px] lg:leading-[150px]">
            BESTSELLERS
          </p>
        </section>
      </div>
